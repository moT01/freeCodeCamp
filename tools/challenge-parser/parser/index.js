...
const addDoltAssignment = require('./plugins/add-dolt-assignment');
const addDoltFillInTheBlank = require('./plugins/add-dolt-fill-in-the-blank');
const addDoltTests = require('./plugins/add-dolt-tests');
const addDoltText = require('./plugins/add-dolt-text');
const addDoltVideoQuestion = require('./plugins/add-dolt-video-question');
...
if (parseForSeedingDoltDb) {
  processor = unified()
    ...
    .use(addDoltFillInTheBlank)
    .use(addDoltVideoQuestion)
    .use(addDoltAssignment)
    .use(addScene)
    .use(addDoltTests)
    .use(addDoltText, ['description', 'instructions', 'notes']);
} else {
